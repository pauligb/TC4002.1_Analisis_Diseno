...
class TestRecordsHandler(unittest.TestCase):
    ...
    def test_add_record(self):
        ...
        # Added record found
        self.assertEqual(capturedOutput.getvalue(), "(1, 'name', 'email', 'age', 'origin')\n")
    ...
    def test_delete_record(self):
        ...
        self.assertEqual(capturedOutput.getvalue(), "(1, 'name1', 'email1', 'age1', 'origin1')\n"\
        ...
        self.assertEqual(capturedOutput.getvalue(), "(2, 'name2', 'email2', 'age2', 'origin2')\n"\
            "(3, 'name3', 'email3', 'age3', 'origin3')\n")
